...
class Settings:
    ...
    chat_model: str = os.getenv("AITUNNEL_CHAT_MODEL", "").strip()
    vision_model: str = os.getenv("AITUNNEL_VISION_MODEL", "").strip()
    image_model: str = os.getenv("AITUNNEL_IMAGE_MODEL", "").strip()
